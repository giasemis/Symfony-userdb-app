...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'giasemis', 'user' => 'giasemis', 'password' => 'giasemis37', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'D:\\EasyPHP\\data\\localweb\\Symfony\\src\\User\\DataBundle\\Entity')), 'User\\DataBundle\\Entity');
        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('UserDataBundle' => 'User\\DataBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('D:/EasyPHP/data/localweb/Symfony/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\EasyPHP\\data\\localweb\\Symfony\\src\\User\\DataBundle/Resources/views', 'UserData');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1a03f232bd489cd543e86544381479090ca929ed');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UserDataBundle' => 'User\\DataBundle\\UserDataBundle',
            ),
            ...
            'database_port' => NULL,
            'database_name' => 'giasemis',
            'database_user' => 'giasemis',
            'database_password' => 'giasemis37',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '1a03f232bd489cd543e86544381479090ca929ed',
            ...
            'kernel.secret' => '1a03f232bd489cd543e86544381479090ca929ed',
